...
function _LockOrientationPortrait() {
...
function _WVPInitialize(autoplay, loop, muted) {
 ...
 player.onwaiting = function() {
  playerData.playerStates.push({
   state: _states.Buffering,
   valueFloat: 0,
   valueLong: -1,
   valueString: undefined
  });
 ...
 player.ontimeupdate = function() {
  if (playerData.ready) {
   playerData.playerStates.push({
    state: _states.PositionChanged,
    valueFloat: player.currentTime / player.duration,
    valueLong: -1,
    valueString: undefined
   });
   playerData.playerStates.push({
    state: _states.TimeChanged,
    valueFloat: -1,
    valueLong: player.currentTime * 1e3,
    valueString: undefined
   });
  }
 };
 player.onerror = function(message) {
  playerData.playerStates.push({
   state: _states.EncounteredError,
   valueFloat: -1,
   valueLong: -1,
   valueString: undefined
  });
...
function _WVPSetDataSource(indx, path) {
 _players[indx].path = UTF8ToString(path);
}

function _WVPSourceDuration(indx) {
 return _players[indx].player.duration;
}

function _WVPSourceFrameTime(indx) {
 return _players[indx].player.currentTime;
}

function _WVPSourceHeight(indx) {
 return _players[indx].player.videoHeight;
}

function _WVPSourceIsMute(indx) {
 return _players[indx].player.muted;
}

function _WVPSourceIsPlaying(indx) {
 var player = _players[indx].player;
 return !(player.paused || player.ended || player.seeking);
}

function _WVPSourceIsReady(indx) {
 return _players[indx].ready;
}

function _WVPSourcePause(indx) {
 _players[indx].player.pause();
}

function _WVPSourcePlay(indx) {
...
function _WVPSourceRelease(indx) {
 var player = _players[indx].player;
...
function _WVPSourceWidth(indx) {
 return _players[indx].player.videoWidth;
}

function _WVPUpdateTexture(indx, textureId) {
...
var asmLibraryArg = {
 ...
 "LockOrientationPortrait": _LockOrientationPortrait,
 ...
 "WVPInitialize": _WVPInitialize,
 "WVPSetDataSource": _WVPSetDataSource,
 "WVPSourceDuration": _WVPSourceDuration,
 "WVPSourceFrameTime": _WVPSourceFrameTime,
 "WVPSourceHeight": _WVPSourceHeight,
 "WVPSourceIsMute": _WVPSourceIsMute,
 "WVPSourceIsPlaying": _WVPSourceIsPlaying,
 "WVPSourceIsReady": _WVPSourceIsReady,
 "WVPSourcePause": _WVPSourcePause,
 "WVPSourcePlay": _WVPSourcePlay,
 "WVPSourceRelease": _WVPSourceRelease,
 "WVPSourceSetFrameTime": _WVPSourceSetFrameTime,
 "WVPSourceSetLoop": _WVPSourceSetLoop,
 "WVPSourceSetMute": _WVPSourceSetMute,
 "WVPSourceStop": _WVPSourceStop,
 "WVPSourceWidth": _WVPSourceWidth,
 "WVPUpdateTexture": _WVPUpdateTexture,
